...
<section class="section">
    <div class="text-end">
        <button type="button" id="click-btn" class="btn btn-primary">Add Brand</button>
    </div>
    <div class="form-slide">
        ...
        <div class="row edit_form"> 
            <form class="row g-3" name="add_form" method="POST" id="add_form" novalidate action="{{route('brands.add')}}" enctype="multipart/form-data">
                @csrf
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="pt-3">Are you sure you want to delete this Brand ?</p>
        </div>
...
$(document).on('click','.deleteBook',function(e){
    var id = $(this).data('id');
    $('.deleteUrl').attr('href','{{route("brands.delete", ["id" => ""]) }}'+id);
});
